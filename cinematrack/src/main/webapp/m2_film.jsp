...
<title>Film modificat cu succes</title>
<style>
body {
...
<body>
	<header>
		<h1>🎬 CinemaTrack - Film Modificat 🎥</h1>
	</header>
	<div class="content">
	<% 
            jb.connect(); 
            ...
            String[] valori = {titlu, gen, an_lansare, durata, descriere}; 
		...
		<a href="modifica_film.jsp" class="view-button">📽️ Vizualizează
			Filme</a>
		<div class="home-icon">
