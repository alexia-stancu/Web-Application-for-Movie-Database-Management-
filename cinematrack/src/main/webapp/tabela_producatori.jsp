...
<script>
	function validateDeletion() {
		const checkboxes = document
				.querySelectorAll('input[name="primarykey"]:checked');
		if (checkboxes.length === 0) {
			window.location.href = "eroare_producator.jsp";
			return false;
		}
...
<body>
	<header>
		<h1>🎬 CinemaTrack - Tabela Producatori 🎥</h1>
	</header>
	<div class="content">
		<h2>Lista de Producatori</h2>
		<form action="sterge_producator.jsp" method="post"
