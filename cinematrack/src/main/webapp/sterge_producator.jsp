...
<title>Ștergere Producător</title>
<style>
body {
...
<body>
	<header>
		<h1>🎬 CinemaTrack - Șterge Producător 🎥</h1>
	</header>
	<div class="content">
		<%
		String[] s = request.getParameterValues("primarykey");
		jb.connect();
		jb.stergeDateTabela(s, "producatori", "idproducator");
		jb.disconnect();
		%>
		<h2>Datele au fost șterse cu succes!</h2>
		<a href="tabela_producatori.jsp" class="view-button">🎥
			Vizualizează Producatori</a>
		<div class="home-icon">
